package com.ohgiraggers.section02.prepared;

/*
* PreparedStaement 는 Statement와 달리 최초 한 번 쿼리를 파싱하고 컴파일하고 캐싱하여 다시 재해석 하는
* 과정(비용)을 생략함으로 인해 불완전하게 작성된 쿠리 실행의 경우는 Statement보다 빠르다.
*
* */
...
public class Application2 {
    public static void main(String[] args) {
        ...
        /* PreparedStatement는 Statement와 달리 placeholder()를 활용한 하나의 문자열 형태로 문자열 쿼리를 작성*/
        String query = "SELECT MENU_NAME, MENU_PRICE FORM tbl_menu WHERE MENU_CODE = ?";
